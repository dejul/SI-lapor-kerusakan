...
class Kategori extends CI_Controller {
	...
	public function index()
	{
		...
		$this->load->view('admin/admin/kategori-management', $data);
	...
	public function edit($id){
		$data = $this->ModelKategori->get_by_id($id);
	...
	public function update(){
		...
		$this->ModelKategori->update(array('id'=>$id),$data);
	...
	public function delete($id){
		$this->ModelKategori->delete_by_id($id);
